...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, OrderFulfilledEventDTO> orderFulfilledProducerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
    ...
    @Bean
    public KafkaTemplate<String, OrderFulfilledEventDTO> orderFulfilledKafkaTemplate() {
        return new KafkaTemplate<>(orderFulfilledProducerFactory());
    }
}
